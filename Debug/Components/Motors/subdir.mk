...
C_SRCS += \
../Components/Motors/motor.c 

OBJS += \
./Components/Motors/motor.o 

C_DEPS += \
./Components/Motors/motor.d 


# Each subdirectory must supply rules for building sources it contributes
Components/Motors/%.o Components/Motors/%.su Components/Motors/%.cyclo: ../Components/Motors/%.c Components/Motors/subdir.mk
...
clean: clean-Components-2f-Motors

clean-Components-2f-Motors:
	-$(RM) ./Components/Motors/motor.cyclo ./Components/Motors/motor.d ./Components/Motors/motor.o ./Components/Motors/motor.su

.PHONY: clean-Components-2f-Motors
